...
1. **Basic Financial Scenarios (L1)** : MCQ-3, MCQ-4, MAQ, T/F, CI, TA
2. **Complex Financial Scenarios (L2)**  : MTD, MIQ, SPQ
3. **Financial Extreme Challenges (L3)** : MCE, CPQ, MLE, CCQ
...
#### 4. **Run a Specific Question Type**
