...
def analyze_images(pipe, image_paths, question, prompt_template="""你是一位专业的金融分析师，擅长图表趋势分析和数据解读。我将提供一张金融图表和相关的单选题(A/B/C/D四个选项)。请你:
...
def analyze_images_api(client, image_paths, question, model_name, prompt_template="""你是一位专业的金融分析师，擅长图表趋势分析和数据解读。我将提供一张金融图表和相关的单选题(A/B/C/D四个选项)。请你:
