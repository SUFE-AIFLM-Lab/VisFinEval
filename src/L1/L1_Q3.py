...
def analyze_images(pipe, image_paths, question, prompt_template="""你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，我将提供给你一道四个选项的多选题。请回答此问题。
...
def analyze_images_api(client, image_paths, question, model_name, prompt_template="""你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，我将提供给你一道四个选项的多选题。请回答此问题。
