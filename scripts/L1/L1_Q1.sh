...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L1_Q1.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L1_Q1"
LOG_DIR="${PROJECT_ROOT}/logs/L1_Q1"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L1/L1_Q1.py"
# --------------------------
# 目录结构验证
# --------------------------
check_prerequisites() {
...
get_base_cmd() {
    ...
    --gpu_ids \"${GPU_IDS}\" \
    --version v1.1 \
    --prompt_template \"你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，我将提供给你一道三选的单项选择题。请回答此问题。
