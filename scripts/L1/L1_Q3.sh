...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L1_Q3.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L1_Q3"
LOG_DIR="${PROJECT_ROOT}/logs/L1_Q3"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/scripts/L1/L1_Q3.py"
# --------------------------
# 目录结构验证
# --------------------------
check_prerequisites() {
...
get_base_cmd() {
    ...
    --log_level INFO \
    --version v1.1 \
    --prompt_template \"你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，我将提供给你一道四个选项的多选题。请回答此问题。
