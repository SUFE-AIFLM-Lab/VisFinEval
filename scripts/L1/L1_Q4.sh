...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L1_Q4.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L1_Q4"
LOG_DIR="${PROJECT_ROOT}/logs/L1_Q4"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L1/L1_Q4.py"
# --------------------------
# 目录结构验证
# --------------------------
check_prerequisites() {
...
get_base_cmd() {
    ...
    --log_level INFO \
    --version v1.1 \
    --prompt_template \"你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，请基于图表严谨地分析以下判断题。
