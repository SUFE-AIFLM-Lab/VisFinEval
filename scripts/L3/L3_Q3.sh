...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L3_Q3.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L3_Q3"
LOG_DIR="${PROJECT_ROOT}/logs/L3_Q3"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L3/L3_Q3.py"

# Prompt模板
PROMPT_TEMPLATE='作为一位专业的金融分析师，请仔细阅读背景故事和图表信息，并回答以下选择题。
