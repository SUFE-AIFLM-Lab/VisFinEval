...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L3_Q2_1.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L3_Q2_1"
LOG_DIR="${PROJECT_ROOT}/logs/L3_Q2_1"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L3/L3_Q2_1_2.py"
