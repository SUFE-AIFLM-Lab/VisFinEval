...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L3_Q2_3_1.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L3_Q2_3_1"
LOG_DIR="${PROJECT_ROOT}/logs/L3_Q2_3_1"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L3/L3_Q2_3_1.py"

# Prompt模板
PROMPT_TEMPLATE='你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，请仔细阅读背景故事和图表信息，并回答以下单项选择题。
