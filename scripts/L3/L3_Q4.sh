...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L3_Q4.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L3_Q4"
LOG_DIR="${PROJECT_ROOT}/logs/L3_Q4"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L3/L3_Q4.py"

# Prompt模板
PROMPT_TEMPLATE='你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，我将提供给你一道金融问题。请基于图表数据进行详细分析，确保答案的准确性和客观性，并归纳出最终结论。请你一步步详细推理，并给出最终结论。请务必将你的最终答案将数字和单位一起使用 \\boxed{{}} 包裹返回，且答案中不包含其他多余内容。'
