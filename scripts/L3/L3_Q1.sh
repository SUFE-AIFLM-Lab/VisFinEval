...
# 输入文件
INPUT_FILE="${PROJECT_ROOT}/data/L3_Q1.tsv"
# 输出目录
OUTPUT_DIR="${PROJECT_ROOT}/output/L3_Q1"
LOG_DIR="${PROJECT_ROOT}/logs/L3_Q1"
# Python脚本
PYTHON_SCRIPT="${PROJECT_ROOT}/src/L3/L3_Q1.py"

# 设置图片和markdown的prompt模板
IMAGE_PROMPT='你是一位专业熟悉金融图表并拥有广泛金融和财务知识的金融学专家，我将提供给你一道四个选项的单项选择题。请回答此问题。
...
MARKDOWN_PROMPT='你是一位专业的金融分析师，我将提供给你一个markdown格式的表格数据和一道四个选项的单项选择题。请根据表格数据回答此问题。
...
get_base_cmd() {
    ...
    --markdown_prompt_template \"${MARKDOWN_PROMPT}\""
}
# --------------------------
# 主执行流程
# --------------------------
